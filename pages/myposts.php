...
<div class="d-flex" class="gradient-background">
    <!-- Sidebar-->
    <div>
    <?php
    include '../navbar.html';
    ...
    <h1 style="display: flex; flex-direction: column; align-items: center; text-align: center;">My Posts</h1>
...
// Fetch posts only for the currently signed-in user
